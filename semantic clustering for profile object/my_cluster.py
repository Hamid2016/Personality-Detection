...
# read data
# path='/home/hamid/PycharmProjects/research/code for project/K-mean semantically on features/cluster-semantic-vectors-master/clustering-symantic-relationship/regular clustring result for n=4/semantic clustering for profile object'
df = pd.read_csv("profile_obj_predicted_ave.csv",header=None)
df0 = pd.read_csv("profile_obj_predicted_ave0.csv",header=None)
df1 = pd.read_csv("profile_obj_predicted_ave1.csv",header=None)
df2 = pd.read_csv("profile_obj_predicted_ave2.csv",header=None)
df3 = pd.read_csv("profile_obj_predicted_ave3.csv",header=None)
...
# df_cluster['regular_cluster_group'] = df[len(df.columns)]
# df_cluster0['regular_cluster_group'] = df0[len(df.columns)]
# df_cluster1['regular_cluster_group'] = df1[len(df.columns)]
# df_cluster2['regular_cluster_group'] = df2[len(df.columns)]
# df_cluster3['regular_cluster_group'] = df3[len(df.columns)]
...
for key in range(len(df_cluster.columns)):
    ...
    #     print('key',key)
    #     pass
path1='D:/rojiyar/my paper/result__/semantic clustring/profile_obj'

df_ave_df_cluster = pd.DataFrame(ave_df_cluster)
df_ave_df_cluster.to_csv(path1+"/profileCnnObj_ave_df_cluster.csv",header=False,index=False)

df_ave_df_cluster0 = pd.DataFrame(ave_df_cluster0)
df_ave_df_cluster0.to_csv(path1+"/profile_ave_df_cluster0.csv",header=False,index=False)

df_ave_df_cluster1 = pd.DataFrame(ave_df_cluster1)
df_ave_df_cluster1.to_csv(path1+"/profileCnnObj_ave_df_cluster1.csv",header=False,index=False)

df_ave_df_cluster2 = pd.DataFrame(ave_df_cluster2)
df_ave_df_cluster2.to_csv(path1+"/profileCnnObj_ave_df_cluster2.csv",header=False,index=False)

df_ave_df_cluster3 = pd.DataFrame(ave_df_cluster3)
df_ave_df_cluster3.to_csv(path1+"/profileCnnObj_ave_df_cluster3.csv",header=False,index=False)

df.to_csv(path1+"/profileCnnObj_predicted_symantic.csv", header=False, index=False)
df0.to_csv(path1+"/profileCnnObj_predicted_symantic0.csv", header=False, index=False)
df1.to_csv(path1+"/profileCnnObj_predicted_symantic1.csv", header=False, index=False)
df2.to_csv(path1+"/profileCnnObj_predicted_symantic2.csv", header=False, index=False)
df3.to_csv(path1+"/profileCnnObj_predicted_symantic3.csv", header=False, index=False)

df_cluster.to_csv(path1+"/profileCnnObj_predicted_symantic_final.csv", header=True, index=False)
df_cluster0.to_csv(path1+"/profileCnnObj_predicted_symantic0_final.csv", header=False, index=False)
df_cluster1.to_csv(path1+"/profileCnnObj_predicted_symantic1_final.csv", header=False, index=False)
df_cluster2.to_csv(path1+"/profileCnnObj_predicted_symantic2_final.csv", header=False, index=False)
df_cluster3.to_csv(path1+"/profileCnnObj_predicted_symantic3_final.csv", header=False, index=False)
